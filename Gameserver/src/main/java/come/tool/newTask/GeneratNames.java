...
public class GeneratNames
{
    ...
    public static String returnName() {
        int index = GameServer.random.nextInt(GeneratNames.Surname.length - 1);
        String name = GeneratNames.Surname[index];
