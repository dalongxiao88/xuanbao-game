...
public interface RoleorderMapper
{
    ...
    int updateByExampleSelective(@Param("record") Roleorder p0, @Param("example") RoleorderExample p1);
    
    int updateByExample(@Param("record") Roleorder p0, @Param("example") RoleorderExample p1);
