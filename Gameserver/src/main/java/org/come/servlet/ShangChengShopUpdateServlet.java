...
public class ShangChengShopUpdateServlet extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ShangchengshopEntity shangchengshopEntity = (ShangchengshopEntity)GsonUtil.getGsonUtil().getgson().fromJson(gsonString, ShangchengshopEntity.class);
        int result = 2;
        if ("1".equals(type)) {
        ...
        else if ("3".equals(type) && AllServiceUtil.getGoodsTableService().addShangChengShop(shangchengshopEntity) == 1) {
            result = 1;
        }
