...
public class PayLJGradeSureAction implements IAction
{
    @Override
    public void action(ChannelHandlerContext ctx, String message) {
        ...
        List<ChongjipackBean> chongList = (List<ChongjipackBean>)GameServer.getPackgradecontrol().get(Integer.valueOf(7));
        ...
        while (i < chongList.size()) {
            ...
            if (chongziGrade == (int)((ChongjipackBean)chongList.get(i)).getPackgradetype()) {
                chongListBean = (ChongjipackBean)chongList.get(i);
                if (paysum.doubleValue() < (double)Double.valueOf((double)(int)((ChongjipackBean)chongList.get(i)).getCanpaymoney())) {
