...
public class denglushibai implements IAction
{
    ...
    public void action(ChannelHandlerContext ctx, String message) {
        ...
        if (null == role) {
            ...
            if (isSuccess) {
                ...
                String mes2 = Agreement.getAgreement().successCreateAgreement(GsonUtil.getGsonUtil().getgson().toJson(loginResult));
                SendMessage.sendMessageToSlef(ctx, mes2);
            }
        }
        else {
            String mes3 = Agreement.getAgreement().errorCreateAgreement();
