...
public class shouji_long implements IAction
{
    @Override
    public void action(ChannelHandlerContext ctx, String message) {
        ...
        if (userTable != null) {
            ...
            String flag = "0";
            if (GameServer.isCode && userTable.getPhonenumber() != null && !"".equals(userTable.getPhonenumber()) && userTable.getPhonenumber() != null && !"".equals(userTable.getPhonenumber())) {
            ...
            String mes = Agreement.getAgreement().successLoginAgreement(userTable.getUser_id() + "|" + selectAtid + "|" + flag + "|" + userTable.getPhonenumber());
