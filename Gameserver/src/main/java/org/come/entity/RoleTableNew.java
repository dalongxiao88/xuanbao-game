...
public class RoleTableNew
{
    ...
    public String toString() {
        ...
        builder.append(this.gangpost);
        builder.append(", achievement=");
        builder.append(this.achievement);
        builder.append(", contribution=");
        builder.append(this.contribution);
        builder.append(", bone=");
        builder.append(this.bone);
        builder.append(", spir=");
        builder.append(this.spir);
        builder.append(", power=");
        builder.append(this.power);
        builder.append(", speed=");
        builder.append(this.speed);
        builder.append(", canpoint=");
        builder.append(this.canpoint);
        builder.append(", captain=");
        builder.append(this.captain);
        builder.append(", savegold=");
        builder.append(this.savegold);
        builder.append(", password=");
        builder.append(this.password);
        builder.append(", gangname=");
        builder.append(this.gangname);
        builder.append(", havebaby=");
        builder.append(this.havebaby);
        builder.append(", newrole=");
        builder.append(this.newrole);
        builder.append(", racename=");
        builder.append(this.racename);
        builder.append(", maxexp=");
        builder.append(this.maxexp);
        builder.append(", marryobject=");
        builder.append(this.marryobject);
        builder.append(", skills=");
        builder.append(this.skills);
        builder.append(", timinggood=");
        builder.append(this.timinggood);
        builder.append(", turnaround=");
        builder.append(this.turnaround);
        builder.append(", taskdaily=");
        builder.append(this.taskdaily);
        builder.append(", born=");
        builder.append(this.born);
        builder.append(", resistance=");
        builder.append(this.resistance);
        builder.append(", servermestring=");
        builder.append(this.servermestring);
        builder.append(", taskreceive=");
        builder.append(this.taskreceive);
        builder.append(", taskcomplete=");
        builder.append(this.taskcomplete);
        builder.append(", taskdata=");
        builder.append(this.taskdata);
        builder.append(", fighting=");
        builder.append(this.fighting);
        builder.append(", dbexp=");
        builder.append(this.dbexp);
        builder.append(", score=");
        builder.append(this.score);
        builder.append(", kill=");
        builder.append(this.kill);
        builder.append(", babyid=");
        builder.append(this.babyid);
        builder.append(", drawing=");
        builder.append(this.drawing);
        builder.append(", calm=");
        builder.append(this.calm);
        builder.append(", xiuwei=");
        builder.append(this.xiuwei);
        builder.append(", fmsld=");
        builder.append(this.fmsld);
        builder.append(", extrapoint=");
        builder.append(this.extrapoint);
        builder.append(", gameTimeRemaining=");
        builder.append(this.gameTimeRemaining);
        builder.append("]");
