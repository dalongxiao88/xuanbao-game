...
public class PaydaygradepayControl implements FromServerAction
{
    @Override
    public void controlMessFromServer(String mes, String type) {
        ...
        EverydayRechargeJframe.getEverydayRechargeJframe().getEverydayRechargeJpanel().showGoods(chongjipackBeans);
    }
}
