...
public class WpanelCashRewardsMain extends JPanel
{
    ...
    public JLabel getChooseGoods() {
        if (this.chooseGoods == null) {
            (this.chooseGoods = new JLabel()).setBounds(55, 192, 55, 53);
        ...
        if (this.textNum == null) {
            ...
            this.textNum.getDocument().addDocumentListener(new DocumentListener() {
                ...
                public void removeUpdate(DocumentEvent e) {
                    String s = WpanelCashRewardsMain.this.textNum.getText();
                    try {
                        int sum = Integer.parseInt(s);
                        if (WpanelCashRewardsMain.this.chooseShop != null) {
                            WpanelCashRewardsMain.this.shopPrice = new BigDecimal((long)sum * WpanelCashRewardsMain.this.chooseShop.getShopprice());
                        }
                    }
            ...
            this.textNum.addKeyListener(new KeyListener() {
                ...
                public void keyTyped(KeyEvent e) {
                    ...
                    String str = WpanelCashRewardsMain.this.textNum.getText();
                    if (str.length() == 0) {
                        WpanelCashRewardsMain.this.textNum.setText("0");
                    }
                    if (charstr < 48 || charstr > 57) {
                        e.consume();
                    }
                    if (str.length() == 1 && str.equals("0")) {
                        WpanelCashRewardsMain.this.textNum.setText("");
                    }
                    if (str.length() > 0 && str.length() > 1) {
                        e.consume();
                        WpanelCashRewardsMain.this.textNum.setText("99");
                        int sum = Integer.parseInt(WpanelCashRewardsMain.this.textNum.getText());
                        if (WpanelCashRewardsMain.this.chooseShop != null) {
                            WpanelCashRewardsMain.this.shopPrice = new BigDecimal((long)sum * WpanelCashRewardsMain.this.chooseShop.getShopprice());
                        }
                    }
    ...
    public BtnSummonEquipMain getExchangeBtn() {
        if (this.exchangeBtn == null) {
            this.exchangeBtn.setBounds(134, 271, 60, 26);
