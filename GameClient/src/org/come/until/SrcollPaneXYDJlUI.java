...
public class SrcollPaneXYDJlUI extends BasicScrollBarUI {
    ...
    private String gdt;
    public SrcollPaneXYDJlUI() {
        gdt = "inkImg/button/xydj-gd.png";
        upurl = "inkImg/button/24.png";
        dwurl = "inkImg/button/25.png";

        this.rh = new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        this.imgZoom = CutButtonImage.cuts(gdt, 2, 2, true);
//        this.imgZoom = CutButtonImage.cuts("inkImg/hongmu/15.png", 6, 6, true);
    }

    protected void configureScrollBarColors() {
        this.setThumbBounds(1, 0, 3, 10);
    ...
    protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
        ...
        g.translate(thumbBounds.x+2, thumbBounds.y);
        Graphics2D g2 = (Graphics2D)g;
        g2.addRenderingHints(this.rh);
        this.imgZoom.drawScroll(g2, thumbBounds.width, thumbBounds.height+50);
    }
    ...
    protected JButton createDecreaseButton(int orientation) {
        ...
        this.up.setBounds(0, 0, 1, 1);
        this.up.setIcon(this.upBtnIcons[0]);
        this.up.addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                SrcollPaneXYDJlUI.this.up.setIcon(SrcollPaneXYDJlUI.this.upBtnIcons[1]);
            }

            public void mousePressed(MouseEvent e) {
                SrcollPaneXYDJlUI.this.up.setIcon(SrcollPaneXYDJlUI.this.upBtnIcons[2]);
            }

            public void mouseExited(MouseEvent e) {
                SrcollPaneXYDJlUI.this.up.setIcon(SrcollPaneXYDJlUI.this.upBtnIcons[0]);
            }
    ...
    protected JButton createIncreaseButton(int orientation) {
        ...
        this.down.setBounds(0, 10, 1, 1);
        this.down.setIcon(this.downBtnIcons[0]);
        this.down.addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                SrcollPaneXYDJlUI.this.down.setIcon(SrcollPaneXYDJlUI.this.downBtnIcons[1]);
            }

            public void mousePressed(MouseEvent e) {
                SrcollPaneXYDJlUI.this.down.setIcon(SrcollPaneXYDJlUI.this.downBtnIcons[2]);
            }

            public void mouseExited(MouseEvent e) {
                SrcollPaneXYDJlUI.this.down.setIcon(SrcollPaneXYDJlUI.this.downBtnIcons[0]);
            }
