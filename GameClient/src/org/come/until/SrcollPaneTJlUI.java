...
public class SrcollPaneTJlUI extends BasicScrollBarUI {
    ...
    private String upurl = "inkImg/button/24.png";
    private String dwurl = "inkImg/button/25.png";
    private String gdt = "inkImg/button/tjgd.png";

    public SrcollPaneTJlUI() {
        this.rh = new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        this.imgZoom = CutButtonImage.cuts(this.gdt, 3, 3, true);
    }
    ...
    protected JButton createDecreaseButton(int orientation) {
        ...
        this.up.addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                SrcollPaneTJlUI.this.up.setIcon(SrcollPaneTJlUI.this.upBtnIcons[1]);
            }

            public void mousePressed(MouseEvent e) {
                SrcollPaneTJlUI.this.up.setIcon(SrcollPaneTJlUI.this.upBtnIcons[2]);
            }

            public void mouseExited(MouseEvent e) {
                SrcollPaneTJlUI.this.up.setIcon(SrcollPaneTJlUI.this.upBtnIcons[0]);
            }
    ...
    protected JButton createIncreaseButton(int orientation) {
        ...
        this.down.addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                SrcollPaneTJlUI.this.down.setIcon(SrcollPaneTJlUI.this.downBtnIcons[1]);
            }

            public void mousePressed(MouseEvent e) {
                SrcollPaneTJlUI.this.down.setIcon(SrcollPaneTJlUI.this.downBtnIcons[2]);
            }

            public void mouseExited(MouseEvent e) {
                SrcollPaneTJlUI.this.down.setIcon(SrcollPaneTJlUI.this.downBtnIcons[0]);
            }
