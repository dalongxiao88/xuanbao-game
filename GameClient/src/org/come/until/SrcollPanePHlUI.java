...
public class SrcollPanePHlUI extends BasicScrollBarUI {
    ...
    private String gdt = "inkImg/button/phgd.png";

    public SrcollPanePHlUI() {
    ...
    protected JButton createDecreaseButton(int orientation) {
        ...
        this.up.addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                SrcollPanePHlUI.this.up.setIcon(SrcollPanePHlUI.this.upBtnIcons[1]);
            }

            public void mousePressed(MouseEvent e) {
                SrcollPanePHlUI.this.up.setIcon(SrcollPanePHlUI.this.upBtnIcons[2]);
            }

            public void mouseExited(MouseEvent e) {
                SrcollPanePHlUI.this.up.setIcon(SrcollPanePHlUI.this.upBtnIcons[0]);
            }
    ...
    protected JButton createIncreaseButton(int orientation) {
        ...
        this.down.addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                SrcollPanePHlUI.this.down.setIcon(SrcollPanePHlUI.this.downBtnIcons[1]);
            }

            public void mousePressed(MouseEvent e) {
                SrcollPanePHlUI.this.down.setIcon(SrcollPanePHlUI.this.downBtnIcons[2]);
            }

            public void mouseExited(MouseEvent e) {
                SrcollPanePHlUI.this.down.setIcon(SrcollPanePHlUI.this.downBtnIcons[0]);
            }
