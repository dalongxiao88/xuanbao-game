...
public class ScrollUI extends BasicScrollBarUI
{
    ...
    protected JButton createDecreaseButton(int orientation) {
        ...
        this.up.addMouseListener(new MouseListener() {
            ...
            public void mouseReleased(MouseEvent e) {
                ScrollUI.this.up.setIcon(ScrollUI.this.upBtnIcons[1]);
            }
            
            @Override
            public void mousePressed(MouseEvent e) {
                ScrollUI.this.up.setIcon(ScrollUI.this.upBtnIcons[2]);
            }
            
            @Override
            public void mouseExited(MouseEvent e) {
                ScrollUI.this.up.setIcon(ScrollUI.this.upBtnIcons[0]);
            }
    ...
    protected JButton createIncreaseButton(int orientation) {
        ...
        this.down.addMouseListener(new MouseListener() {
            @Override
            public void mouseReleased(MouseEvent e) {
                ScrollUI.this.down.setIcon(ScrollUI.this.downBtnIcons[1]);
            }
            
            @Override
            public void mousePressed(MouseEvent e) {
                ScrollUI.this.down.setIcon(ScrollUI.this.downBtnIcons[2]);
            }
            
            @Override
            public void mouseExited(MouseEvent e) {
                ScrollUI.this.down.setIcon(ScrollUI.this.downBtnIcons[0]);
            }
