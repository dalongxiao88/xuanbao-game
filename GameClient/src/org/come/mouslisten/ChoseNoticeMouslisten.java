...
public class ChoseNoticeMouslisten implements MouseListener
{
    private ZhuJpanel zhuJpanel;
    
    public ChoseNoticeMouslisten(ZhuJpanel zhuJpanel) {
    ...
    public void mouseReleased(MouseEvent e) {
        String msg = this.zhuJpanel.getLabnotice().getText();
        ...
        MyAWTEventListener.setMesageType("传音");
