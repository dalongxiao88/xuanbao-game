...
public class ChoseBangsMouslisten implements MouseListener
{
    private ZhuJpanel zhuJpanel;
    
    public ChoseBangsMouslisten(ZhuJpanel zhuJpanel) {
    ...
    public void mouseReleased(MouseEvent e) {
        String msg = this.zhuJpanel.getLabbangs().getText();
        ...
        MyAWTEventListener.setMesageType("帮派");
