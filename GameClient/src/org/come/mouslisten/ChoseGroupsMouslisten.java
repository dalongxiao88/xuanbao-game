...
public class ChoseGroupsMouslisten implements MouseListener
{
    private ZhuJpanel zhuJpanel;
    
    public ChoseGroupsMouslisten(ZhuJpanel zhuJpanel) {
    ...
    public void mouseReleased(MouseEvent e) {
        String msg = this.zhuJpanel.getLabgroups().getText();
        ...
        MyAWTEventListener.setMesageType("队伍");
