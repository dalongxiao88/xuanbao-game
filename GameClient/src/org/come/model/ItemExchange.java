...
public class ItemExchange
{
    ...
    public String toString() {
        return "itemExchange{eId=" + this.eId + ", type='" + this.type + '\'' + ", consume='" + this.consume + '\'' + ", goods=" + this.goods + ", goodsname='" + this.goodsname + '\'' + ", skin='" + this.skin + '\'' + ", quality=" + this.quality + ", rgid=" + this.rgid + ", status=" + this.status + ", value='" + this.value + '\'' + ", instruction='" + this.instruction + '\'' + '}';
    }
