...
public class MyRendererOld extends JPanel implements ListCellRenderer
{
    private int index;
    ...
    public MyRendererOld() {
        this.color = Color.white;
        this.index = 67;
    }
    
    public MyRendererOld(int index) {
        this.color = Color.white;
        this.index = 67;
        this.index = index;
    }
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        MyRendererOld mr = new MyRendererOld(index);
        mr.removeAll();
        if (isSelected) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawString(MyRendererOld.vs = ((RoleSummoning)UserMessUntil.getPetListTable().get(this.index)).getSummoningname(), 18, 17);
