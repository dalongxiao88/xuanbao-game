...
public class LotteryJpanel extends JPanel{
...
//            labGoodsImg[i].setIcon(GoodsListFromServerUntil.imgpathAdaptive("54aa", 53, 53));
    ...
    public TrueFeedbackBtn getBtnLottey() {
        if(btnLottey == null){
            btnLottey = new TrueFeedbackBtn("inkImg/button1/B21.png" ,1, 101, "抽奖", UIUtils.COLOR_BTNPUTONG, UIUtils.TEXT_HY16, this);
