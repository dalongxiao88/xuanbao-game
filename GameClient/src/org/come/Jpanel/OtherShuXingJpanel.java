...
public class OtherShuXingJpanel extends JPanel
{
    ...
    public OtherShuXingJpanel() {
        this.icon = new ImageIcon("img/xy2uiimg/kx_qt.png");
        this.icon2 = new ImageIcon("img/xy2uiimg/personalLast.png");
        this.setBackground(new Color(0, 0, 0, 0));
        this.setPreferredSize(new Dimension(290, 100));
        this.setLayout(null);
        this.dlm = new DefaultListModel<>();
        this.dlm1 = new DefaultListModel<>();
        (this.listNo1 = new JList<>()).setBounds(20, 26, 130, 50);
        ...
        (this.listNo2 = new JList<>()).setBounds(150, 26, 130, 50);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(this.icon2.getImage(), 0, 62, 290, 5, this);
    }
