...
public class TakeBackPawnGoodsJpanel1 extends JPanel implements MouseListener
{
    ...
    public TakeBackPawnGoodsJpanel1() throws Exception {
        ...
        if (MyIsif.getStyle().equals("水墨")) {
            ...
            FormsOnOffBtn offBtn = new FormsOnOffBtn("inkImg/button/1.png", 1, 55);
            offBtn.setBounds(349, 10, 25, 25);
            this.add(offBtn);
            for (int i = 0; i < 42; ++i) {
                int row = i % 6;
                int col = i / 6;
            ...
            this.setLayout(null);
            this.setBackground(UIUtils.Color_BACK);
            FormsOnOffBtn offBtn = new FormsOnOffBtn("img/xy2uiimg/8_jpg.button.btn_close.jpg", 1, 55);
    ...
    class fy implements MouseListener
    {
        ...
        @Override
        public void mouseClicked(MouseEvent e) {
            for (int i = 0; i < TakeBackPawnGoodsJpanel1.this.jabs.length; ++i) {
                if (this.y - 1 == i) {
                    TakeBackPawnGoodsJpanel1.this.jabs[i].setForeground(Color.YELLOW);
                    TakeBackPawnGoodsJpanel1.this.jabs[i].setFont(UIUtils.TEXT_FONT1B);
                }
                else {
                    TakeBackPawnGoodsJpanel1.this.jabs[i].setForeground(Color.WHITE);
                    TakeBackPawnGoodsJpanel1.this.jabs[i].setFont(UIUtils.TEXT_FONT1);
                }
            }
        }
