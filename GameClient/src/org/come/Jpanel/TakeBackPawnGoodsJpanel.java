...
public class TakeBackPawnGoodsJpanel extends JPanel implements MouseListener
{
    ...
    public TakeBackPawnGoodsJpanel() throws Exception {
    ...
    class fy implements MouseListener
    {
        ...
        @Override
        public void mouseClicked(MouseEvent e) {
            for (int i = 0; i < TakeBackPawnGoodsJpanel.this.jabs.length; ++i) {
                if (this.y - 1 == i) {
                    TakeBackPawnGoodsJpanel.this.jabs[i].setForeground(Color.YELLOW);
                    TakeBackPawnGoodsJpanel.this.jabs[i].setFont(UIUtils.TEXT_FONT1B);
                }
                else {
                    TakeBackPawnGoodsJpanel.this.jabs[i].setForeground(Color.WHITE);
                    TakeBackPawnGoodsJpanel.this.jabs[i].setFont(UIUtils.TEXT_FONT1);
                }
            }
        }
