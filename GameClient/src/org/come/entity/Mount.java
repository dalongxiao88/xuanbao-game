...
public class Mount
{
    ...
    public boolean isID(BigDecimal ID) {
        return ID != null && ((this.sid != null && this.sid.compareTo(ID) == 0) || (this.othrersid != null && this.othrersid.compareTo(ID) == 0) || (this.sid3 != null && this.sid3.compareTo(ID) == 0) || (this.sid4 != null && this.sid4.compareTo(ID) == 0) || (this.sid5 != null && this.sid5.compareTo(ID) == 0));
    }
    ...
    public String getMountlvlString() {
        ...
        return "点化" + ((int)this.mountlvl - 100) + "级";
    }
    ...
    public Integer getMoveGrade() {
        if (this.moveGrade == null) {
            this.moveGrade = Integer.valueOf(0);
        }
