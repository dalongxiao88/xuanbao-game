...
public class SkillSMSelectOptionJpanel extends JPanel
{
    ...
    public SkillSMSelectOptionJpanel(int width, int heigth, String backPath, String[] rowData) {
        this.width = width;
        this.heigth = heigth;
        this.backPath = backPath;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (this.icon == null) {
            this.icon = new ImageIcon(this.backPath);
        }
