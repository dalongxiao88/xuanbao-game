...
public class WingUpStarMouseListener extends MouseAdapter
{
    private int type;
    private WingMainPanel wingMainPanel;
    
    public WingUpStarMouseListener(int type, WingMainPanel wingMainPanel) {
        this.type = type;
    ...
    public void mousePressed(MouseEvent e) {
        ...
        this.wingMainPanel.setMoney(getGoodsTrue(wingUpStarGoods, goodsValue));
        if (this.wingMainPanel.getMoney() == null) {
        ...
        this.wingMainPanel.setChosegoods(wingUpStarGoods);
        ...
        this.wingMainPanel.getNumberLab().setText(qualityNumber);
    }
