...
public class SystemBoos
{
    ...
    public SystemBoos(String text, String skin) {
        this.skin = skin;
        this.CZ(text);
    }
    ...
    public void draw(Graphics g) {
        ...
        if (this.value < this.length) {
            Graphics g2 = g.create(-1, ScrenceUntil.Screen_y - 769, ScrenceUntil.Screen_x, 770);
            if (this.tcp == null) {
                ...
                if (frame != null && frame.getImage() != null) {
                    g2.drawImage(frame.getImage(), frame.getRefPixelX(), frame.getRefPixelY(), ScrenceUntil.Screen_x, frame.getHeight(), null);
                }
            }
    ...
    public void CZ(String text) {
        ...
        if (this.text == null) {
            this.text = new RichLabel(text, UIUtils.TEXT_HY24, 9999);
        }
        else {
        ...
        this.value = 0;
        this.height = (int)(138.0 - this.text.getSize().getHeight());
    }
}
